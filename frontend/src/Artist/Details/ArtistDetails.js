      ...
      <PageContent title={artistName}>
        ...
        <PageContentBodyConnector innerClassName={styles.innerContentBody}>
          ...
          <div className={styles.metadataMessage}>
            Missing Albums, Singles, or Other Types? Modify or create a new <Link to='/settings/profiles'>Metadata Profile</Link> or manually <Link to='/add/search'>Search</Link> for new items!
          </div>
